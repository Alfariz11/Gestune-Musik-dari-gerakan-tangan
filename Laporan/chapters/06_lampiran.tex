...
12/11/2025 & Finalisasi Laporan dan Perbaikan Minor pada Code & Penyelesaian laporan tugas besar, perbaikan minor pada kode dan dokumentasi \\ \hline
\end{tabular}
\end{table}
...
\begin{itemize}
    ...
    \item \textbf{Video}: \url{https://youtu.be/rLHPHB-vdGE?si=GlDebpr-tt8r3Ufi}
